...
var data = [
    { "label": "水餃", "value": 1, "award": "水餃" }, // padding
    { "label": "大盛", "value": 1, "award": "大盛" }, //font-family
    { "label": "冷麵", "value": 1, "award": "冷麵" }, //color
    { "label": "猜拳輸的想", "value": 0, "award": "猜拳輸的想" }, //font-weight
...
var newData = [
    { "label": "咖哩飯", "value": 1, "award": "咖哩飯" }, 
    { "label": "披薩", "value": 1, "award": "披薩" }, 
    // 新的选项对象
];
...
arcs.append("path")
    .attr("fill", function(d, i){ return color(i); }) // 使用颜色比例尺来选择颜色
    ...
    vis.transition()
        ...
        .each("end", function () {
            ...
            if(data[picked].value == 0){
                d3.select("#awardresult h5")
                .text("" + data[picked].award + " 快猜拳！");
             }else{
               d3.select("#awardresult h5")
                .text("今天就吃「" + data[picked].award + "」!");
             }
